...
public class GunSC : ScriptableObject
{
    ...
    public ShootConfigSC ShootConfig;
    public TrailConfigSC TrailConfig;
    ...
    public void Spawn(Transform Parent, MonoBehaviour ActiveMonoBehavior)
    {
        ...
        LastShootTime = 0; //In editor this will not be properly set, the build should be fine though
